...
void DirectXApp::Render()
{
	...
	constantBuffer.DirectionalLightColour = Vector4(Colors::Cyan); // Color of the light
...
void DirectXApp::GenerateVertexNormal()
{
		...
		for (size_t i = 0; i < ARRAYSIZE(vertices); i += 1)
		{
			...
			// Divide the summed vertex normal by the number of times they were contributed to
