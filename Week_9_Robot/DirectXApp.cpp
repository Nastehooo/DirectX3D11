...
void DirectXApp::CreateSceneGraph()
{
    ...
    // Body
    shared_ptr<CubeNode> body = make_shared<CubeNode>(L"Body", Vector4(0.8f, 0.6f, 0.4f, 1.0f)); //brown
    body->SetWorldTransform(Matrix::CreateScale(Vector3(5.0f, 8.0f, 2.5f)) * Matrix::CreateTranslation(Vector3(0.0f, 23.0f, 0.0f)));
    sceneGraph->Add(body);

    // Left Leg
    shared_ptr<CubeNode> leftLeg = make_shared<CubeNode>(L"LeftLeg", Vector4(0.8f, 0.6f, 0.4f, 1.0f)); //brown
    ...
    // Right Leg
    shared_ptr<CubeNode> rightLeg = make_shared<CubeNode>(L"RightLeg", Vector4(0.8f, 0.6f, 0.4f, 1.0f)); //brown 
    ...
    // Head
    shared_ptr<CubeNode> head = make_shared<CubeNode>(L"Head", Vector4(0.8f, 0.6f, 0.4f, 1.0f)); //brown
    ...
    // Left Arm
    shared_ptr<CubeNode> leftArm = make_shared<CubeNode>(L"LeftArm", Vector4(0.8f, 0.6f, 0.4f, 1.0f)); //brown
    leftArm->SetWorldTransform(Matrix::CreateTranslation(Vector3(-6.0f, 22.0f, 0.0f)));
    leftShoulderSceneGraph->Add(leftArm);

    // Right Arm
    shared_ptr<CubeNode> rightArm = make_shared<CubeNode>(L"RightArm", Vector4(0.8f, 0.6f, 0.4f, 1.0f));  //brown
